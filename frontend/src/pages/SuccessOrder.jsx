...
import { FaCheckCircle, FaClipboardCheck, FaArrowLeft, FaStore } from "react-icons/fa";
  ...
  if (!order) {
    return (
      <div className="flex flex-col gap-4 justify-center items-center min-h-screen">
        <p className="text-2xl md:text-3xl lg:text-[2.5rem]">No order found :(</p>
        <Link to="/">
        ...
        <div className="flex flex-col items-center justify-center gap-8 lg:gap-16 bg-deepGray shadow-2xl rounded-sm shadow-black px-8 py-10 lg:px-20 lg:py-16">
          ...
          <div className="text-center space-y-4 lg:space-y-6">
            ...
            <p className="text-lg md:text-xl lg:text-2xl max-w-lg">
              Thank you, <strong className="text-softBeigeYellow">{order.fullname},</strong> your order has been successfully placed!
            </p>
          </div>
